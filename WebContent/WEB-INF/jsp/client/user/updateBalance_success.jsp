  ...
  <body>
    ...
    <div id="con">
    	<div id="c_con">
    		<div id="c_con_d1">
    			<ul>
    				<li><span>您已成功充值</span></li>
    			</ul>
    		</div>
    		<div id="c_con_d2">
    			<ul>
    				<li><span>您当前的余额为：</span><span class="c_con_d2_s" style="color:#4C8FBD;">￥</span><span class="c_con_d2_s" style="color:#4C8FBD;">${user.balance }</span></li>
    				<li><span>点击&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="user/my_shopping">跳转至个人中心</a></li>
    			</ul>
    		</div>
    	</div>
    </div>
